        ...
        try (SocketChannel socketChannel = SocketChannel.open(address)) {
            ...
            while (true) {
                ...
                if (partName.equalsIgnoreCase("quit")) {
                    HelpMethod.sendMessage(socketChannel, "quit");
                    break;
                } else {
                    HelpMethod.sendMessage(socketChannel, partName);
                    System.out.println("The price is " + HelpMethod.receiveMessage(socketChannel));
                }
            }
